// app/api/client/dashboard/deewan/qata/[slug]/comments/route.ts
...
export async function GET(
  ...
  try {
    ...
    const allComments = qata.comments || [];
...
export async function POST(
  ...
  try {
    ...
    const commentWithUser = {
      ...newComment,
      _id: qata.comments[qata.comments.length - 1]._id,
      user,
    };
    ...
    return NextResponse.json(
      {
        ...
        data: {
          ...
          status: {
            totalComments: qata.comments.length,
...
export async function DELETE(
  ...
  try {
    ...
    const commentIndex = qata.comments.findIndex(
    ...
    const comment = qata.comments[commentIndex];
    ...
    qata.comments.splice(commentIndex, 1);
    await qata.save();

    const hasUserCommented = qata.comments.some(
