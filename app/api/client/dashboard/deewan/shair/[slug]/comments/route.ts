// app/api/client/dashboard/deewan/shair/[slug]/comments/route.ts
...
export async function GET(
  ...
  try {
    ...
    const allComments = shair.comments || [];
...
export async function POST(
  ...
  try {
    ...
    shair.comments.push(newComment);
    await shair.save();
    ...
    const commentWithUser = {
      ...newComment,
      _id: shair.comments[shair.comments.length - 1]._id,
      user,
    };
    ...
    return NextResponse.json(
      {
        ...
        data: {
          ...
          status: {
            totalComments: shair.comments.length,
...
export async function DELETE(
  ...
  try {
    ...
    const comment = shair.comments[commentIndex];
    ...
    shair.comments.splice(commentIndex, 1);
    await shair.save();
